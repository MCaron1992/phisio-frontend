...
import { Metrica, useMetriche, useDeleteMetrica, useUpdateMetrica } from '@/hooks/useCrud';
...
const MetricaTable = () => {
  ...
  const rowActions: DataTableAction<Metrica>[] = [
    {
      id: 'view',
      label: 'Visualizza',
  ...
  return (
    <>
      ...
      />
      <DeleteConfirmDialog
        onConfirm={() => deleteMetrica({ id: selectedRow?.id! })}
