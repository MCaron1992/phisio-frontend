...
const StrutturaSpecificaTable = () => {
  ...
  const [selectedRow, setSelectedRow] = useState<StruttureSpecifiche | null>(null);
  ...
  return (
    <>
      ...
      />
      <DeleteConfirmDialog
        onConfirm={() => deleteStrutturaSpecifica({ id: selectedRow?.id! })}
